IF NOT EXISTS (SELECT 1 FROM sys.databases WHERE name = 'NodoMaestroUAQ')
BEGIN
	CREATE DATABASE NodoMaestroUAQ;
END
...
-- (5) Datos personales privados del alumno
...
-- (7) Datos personales del profesor
...
-- (8) Datos personales privados del profesor
...
-- (9) Datos laborales del profesor
...
-- (12) Inscripciones de alumnos en la Universidad
